-- Add diagnostic_html and framework_pme_data to type CHECK constraint
-- Migration 0018: extends 0017 with diagnostic expert support

-- Step 1: Create new table with all types
CREATE TABLE IF NOT EXISTS entrepreneur_deliverables_new (
  ...
  type TEXT NOT NULL CHECK(type IN (
    ...
    'bmc_html', 'sic_html', 'inputs_html', 'framework_html', 'framework_pme_data', 'diagnostic_html'
  )),
  content TEXT,
  score INTEGER,
